...
const Hero = () => {
  return (
    <div className="relative bg-black pt-24 pb-16 sm:pt-32 lg:overflow-hidden">
      {/* Video Background */}
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        >
          <source
            src="https://tdnuswekfcjgvqyiotoj.supabase.co/storage/v1/object/public/videos/hero-background.mp4"
            type="video/mp4"
          />
